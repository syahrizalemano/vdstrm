    ...
    if int(assistant) == 1:
        try:
            ...
            return await mystic.edit(
                "Change Video Stream Gagal, Ulangi."
            )
    elif int(assistant) == 2:
        try:
            await pytgcalls2.change_stream(
        ...
        if Queues.is_empty(chat_id):
            ...
            if str(finxx) == "raw":
                ...
                finaltext = await app.send_photo(
                    ...
                    caption=f"-<b>__Mulai Bermain:__</b> {title} \n-<b>__Request Dari__ </b> {mention}",
                )
                await start_timer(
                    videoid,
                    duration_min,
                ...
                if int(quality) == 1080:
                    ...
                    finaltext = await app.send_photo(
                        ...
                        reply_markup=InlineKeyboardMarkup(buttons),
                        caption=(
                            f"**Video Streaming**\n\n-<b>__Mulai Bermain:__ </b>Lagu Selanjutnya \n-**__Requested Dari:__** {mention}"
                        ),
                    )
                else:
                    (
                    ...
                    finaltext = await app.send_photo(
                        ...
                        reply_markup=InlineKeyboardMarkup(buttons),
                        caption=(
                            f"**Video Streaming**\n\n-<b>__Mulai Bermain:__ </b>[{title[:25]}](https://www.youtube.com/watch?v={afk}) \n-**__Requested Dari:__** {mention}"
                        ),
                    )
                    os.remove(thumb)
                    await start_timer(
                ...
                finaltext = await app.send_photo(
                    ...
                    reply_markup=InlineKeyboardMarkup(buttons),
                    caption=(
                        f"-<b>__Mulai Bermain:__ </b>[{title[:25]}](https://www.youtube.com/watch?v={afk}) \n-**__Requested Dari:__** {mention}"
                    ),
                )
                os.remove(thumb)
                videoid = afk
