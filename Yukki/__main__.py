...
async def initiate_bot():
    ...
    console.print(
        "[bold green]Congrats!! Music Bot has started successfully!\n"
    )
    try:
    ...
    if STRING1 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_1.join_chat("anomusic")
            await ASS_CLI_1.join_chat("anomusic")
        except:
            pass
    ...
    if STRING2 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_2.join_chat("anomusic")
            await ASS_CLI_2.join_chat("anomusic")
        except:
            pass
    ...
    if STRING3 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_3.join_chat("anomusic")
            await ASS_CLI_3.join_chat("anomusic")
        except:
            pass
